...
use crate::device_agent_config::DeviceShadowConfig;

pub const DEVICE_AGENT_VERSION: &str = env!("VERGEN_BUILD_SEMVER");

#[derive(Debug, Serialize)]
struct State {
    device_agent_version: &'static str,
}
...
impl DeviceShadow {
    pub fn new(config: DeviceShadowConfig, bridge: BridgeTx) -> Self {
        Self {
            ...
            bridge,
            sequence: 0,
            state: State { device_agent_version: DEVICE_AGENT_VERSION },
        }
    }
