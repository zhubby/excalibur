...
impl From<&System> for Payload {
    fn from(value: &System) -> Self {
        ...
        Payload {
            stream: "device_agent_system_stats".to_owned(),
            sequence: *sequence,
            timestamp: *timestamp,
            payload: json!({
...
impl From<&mut Network> for Payload {
    fn from(value: &mut Network) -> Self {
        ...
        Payload {
            stream: "device_agent_network_stats".to_owned(),
            sequence: *sequence,
            timestamp: *timestamp,
            payload: json!({
                "name": name,
...
impl From<&mut Disk> for Payload {
    fn from(value: &mut Disk) -> Self {
        ...
        Payload {
            stream: "device_agent_disk_stats".to_owned(),
            sequence: *sequence,
            timestamp: *timestamp,
            payload: json!({
                "name": name,
...
impl From<&mut Processor> for Payload {
    fn from(value: &mut Processor) -> Self {
        ...
        Payload {
            stream: "device_agent_processor_stats".to_owned(),
            sequence: *sequence,
            timestamp: *timestamp,
            payload: json!({
                "name": name,
...
impl From<&mut Component> for Payload {
    fn from(value: &mut Component) -> Self {
        ...
        Payload {
            stream: "device_agent_component_stats".to_owned(),
            sequence: *sequence,
            timestamp: *timestamp,
            payload: json!({
...
impl From<&mut Process> for Payload {
    fn from(value: &mut Process) -> Self {
        ...
        Payload {
            stream: "device_agent_process_stats".to_owned(),
            sequence: *sequence,
            timestamp: *timestamp,
            payload: json!({
                "pid": pid,
