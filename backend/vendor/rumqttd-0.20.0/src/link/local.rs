...
use crate::{ConnectionId, PublishAuthHandler, SubscribeAuthHandler};
use bytes::Bytes;
...
impl<'a> LinkBuilder<'a> {
    ...
    pub fn subscribe_auth(mut self, subscribe_auth: Option<SubscribeAuthHandler>) -> Self {
        self.subscribe_auth = subscribe_auth;
        self
    }

    pub fn publish_auth(mut self, publish_auth: Option<PublishAuthHandler>) -> Self {
