...
export function Sidebar() {
  return (
    <>
      <aside className="hidden min-h-screen w-64 shrink-0 bg-rail text-ink shadow-rail lg:flex lg:flex-col">
          ...
          {navItems.map((item) => (
            <button
              ...
              className={`flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-left text-sm transition ${
                item.active ? "bg-brand text-ink" : "text-muted hover:bg-elevated hover:text-ink"
              }`}
              type="button"
            >
        ...
        <div className="border-t border-line/70 p-3">
          <button
            className="flex w-full items-center gap-3 rounded-md px-3 py-2.5 text-left text-sm text-muted transition hover:bg-elevated hover:text-ink"
            type="button"
          >
